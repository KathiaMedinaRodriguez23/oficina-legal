                ...
                <div class="row">
                   ...
                   <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                     ...
                     <button type="submit" id="search" disabled="disabled"  class="btn btn-success"> <i class="fa fa-search"></i> Buscar</button>
                   </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
               ...
               <a  href="{{url('admin/case-important')}}">Casos Importantes</a>
                ...
                <li role="presentation" class="{{(Request::is('admin/case-nb'))?'active':''}} ">
                  <a   href="{{url('admin/case-nb')}}">Casos de Comité o Junta</a>
              </li>
                 ...
                 <a   href="{{url('admin/case-archived')}}">Casos Archivados</a>
                     ...
                     <table id="case_list" class="table" >
                        <thead>
                            <tr>
                                <th width="3%">Nº</th>
                                <th width="20%">Cliente & Detalle Caso</th>
